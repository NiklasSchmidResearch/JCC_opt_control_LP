...
The main.py file features a simulation that solves a joint chance constrained optimal control problem, where the joint chance constraint represents an invariance, reachability or reach-avoid specification. 
...
- the files "invariance_low.png", "reachability_low.png", "reachavoid_low.png" depict the target, safe and unsafe sets. The green dot represents the initial state of the system.